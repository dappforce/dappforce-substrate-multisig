...
class InputStorage extends _react.default.PureComponent {
  constructor(props) {
    ...
    const _this$props = this.props,
          _api = _this$props.api,
          section = _this$props.defaultValue.section;
    this.state = {
  ...
  render() {
    const _this$props2 = this.props,
          ...
          withLabel = _this$props2.withLabel;
    const _this$state = this.state,
          optionsMethod = _this$state.optionsMethod,
          optionsSection = _this$state.optionsSection,
